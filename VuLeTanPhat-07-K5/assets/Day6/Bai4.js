let count = 1; //global scope voi let de cap nhat gia tri

const intervalId = setInterval(() =>{ // in ra moi giay nho interval
    console.log(count);
    count++;

    if (count > 10) { //dieu kien dung
        clearInterval(intervalId); //clearInterval de dung lai
    }
},1000)

// setnterval co the lap lai lien tuc con setTimeout chi chay 1 lan
